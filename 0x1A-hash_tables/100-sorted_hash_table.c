...
/**
 * shash_table_get - function to retrieve
 * @ht: pointer 
 * @key: key to 
 *
...
/**
 * shash_table_print_rev - function to print the key
...
/**
 * shash_table_delete - free hash table and nodes
 * @ht: pointer to hash table
 *
 */
